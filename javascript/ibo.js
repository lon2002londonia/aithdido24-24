...
function changeibo(){
    j++;
    backgroundchange3.style.backgroundImage ="url(\"image2/ibo/koora"+ j +".jpg\")";
    displayangle2();
}
function changeibo1(){
    j--;
...
for(var box1=1;box1<13;box1++){
    box.innerHTML+="<div class=\"box\" id=\"boxbox"+box1+"\"></div>"
    boxbox=document.getElementById("boxbox"+box1);
    boxbox.innerHTML="<img src=\"image2/ibo/i" + box1 + ".jpg\"\\><h3>صورة رقم "+ box1 +" </h3>"
}